 ...
 * not confuse the two terms鈥攁gain, an action is a payload of information, and
 ...
 *
 * Reducers are not unique to Redux鈥攖hey are a fundamental concept in
 ...
 * state and an action. They must be *pure functions*鈥攆unctions that return
...
interface Store<S = any, A extends Action = UnknownAction, StateExt extends unknown = unknown> {
     ...
     *
     * @param action A plain object representing 鈥渨hat changed鈥? It is a good
 ...
 * React, which are also occasionally called 鈥渃omponent enhancers鈥?
 *
