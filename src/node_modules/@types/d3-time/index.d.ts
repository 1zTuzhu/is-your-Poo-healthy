...
export interface CountableTimeInterval extends TimeInterval {
     ...
     *
     * The meaning of step is dependent on this interval鈥檚 parent interval as defined by the field function.
     *
     ...
     * timeDay鈥檚 parent interval is timeMonth, and thus the interval number resets at the start of each month.
     *
