...
export interface DefaultArcObject {
    ...
    outerRadius: number;
    /**
     * Start angle of arc. The angle is specified in radians, with 0 at -y (12 o鈥檆lock) and positive angles proceeding clockwise.
     */
    startAngle: number;
    /**
     * End angle of arc. The angle is specified in radians, with 0 at -y (12 o鈥檆lock) and positive angles proceeding clockwise.
     */
    endAngle: number;
    /**
 ...
 *
 * If the difference between the start and end angles (the angular span) is greater than 蟿, the arc generator will produce a complete circle or annulus.
 * If it is less than 蟿, arcs may have rounded corners and angular padding. Arcs are always centered at 鉄?,0鉄? use a transform (see: SVG, Canvas) to move the arc to a different position.
 *
...
export interface Arc<This, Datum> {
     ...
     * In addition, for arcs whose angular span is less than 蟺, the corner radius may be reduced as two adjacent rounded corners intersect.
     ...
     *
     * The angle is specified in radians, with 0 at -y (12 o鈥檆lock) and positive angles proceeding clockwise.
     * If |endAngle - startAngle| 鈮?蟿, a complete circle or annulus is generated rather than a sector.
     *
     ...
     * If the arc forms a complete circle or annulus, as when |endAngle - startAngle| 鈮?蟿, the pad angle is ignored. If the inner radius or angular span is small relative to the pad angle,
     ...
     *
     * The recommended minimum inner radius when using padding is outerRadius * padAngle / sin(胃), where 胃 is the angular span of the smallest arc before padding.
     * For example, if the outer radius is 200 pixels and the pad angle is 0.02 radians, a reasonable 胃 is 0.04 radians, and a reasonable inner radius is 100 pixels.
     *
...
export interface PieArcDatum<T> {
     ...
     * then the units are in radians with 0 at -y (12 o鈥檆lock) and positive angles proceeding clockwise.
     */
    startAngle: number;
    /**
...
export interface Pie<This, Datum> {
    /**
     * Generates a pie for the given array of data, returning an array of objects representing each datum鈥檚 arc angles.
     * Any additional arguments are arbitrary; they are simply propagated to the pie generator鈥檚 accessor functions along with the this object.
     ...
     *
     * This representation is designed to work with the arc generator鈥檚 default startAngle, endAngle and padAngle accessors.
     * The angular units are arbitrary, but if you plan to use the pie generator in conjunction with an arc generator,
     * you should specify angles in radians, with 0 at -y (12 o鈥檆lock) and positive angles proceeding clockwise.
     *
     ...
     * you should specify an angle in radians, with 0 at -y (12 o鈥檆lock) and positive angles proceeding clockwise.
     *
     ...
     * you should specify an angle in radians, with 0 at -y (12 o鈥檆lock) and positive angles proceeding clockwise.
     *
     * The value of the end angle is constrained to startAngle 卤 蟿, such that |endAngle - startAngle| 鈮?蟿.
     *
     * @param angle A constant angle.
     */
    endAngle(angle: number): this;
...
export interface Line<Datum> {
    /**
     * Generates a line for the given array of data. Depending on this line generator鈥檚 associated curve,
 ...
 * Radial lines are always positioned relative to 鉄?,0鉄? use a transform (see: SVG, Canvas) to change the origin.
 *
 * The generic refers to the data type of an element in the input array passed into the line generator.
 */
export interface LineRadial<Datum> {
    /**
     * Generates a radial line for the given array of data. Depending on this radial line generator鈥檚 associated curve,
     * the given input data may need to be sorted by x-value before being passed to the line generator.
     *
     ...
     *
     * @param angle A constant angle value in radians, with 0 at -y (12 o鈥檆lock).
     */
     ...
     * then you should specify a custom accessor.
     *
     * @param angle An angle accessor function which returns the angle value in radians, with 0 at -y (12 o鈥檆lock). The angle accessor will be invoked for each defined element in the input data array,
     * being passed the element d, the index i, and the array data as three arguments.
     */
...
export interface Area<Datum> {
    /**
     * Generates an area for the given array of data. Depending on this area generator鈥檚 associated curve,
    ...
    /**
     * Returns a new line generator that has this area generator鈥檚 current defined accessor, curve and context.
     * The line鈥檚 x-accessor is this area鈥檚 x0-accessor, and the line鈥檚 y-accessor is this area鈥檚 y0-accessor.
     */
    lineX0(): Line<Datum>;
    /**
     * Returns a new line generator that has this area generator鈥檚 current defined accessor, curve and context.
    ...
    /**
     * Returns a new line generator that has this area generator鈥檚 current defined accessor, curve and context.
     * The line鈥檚 x-accessor is this area鈥檚 x1-accessor, and the line鈥檚 y-accessor is this area鈥檚 y0-accessor.
     */
    lineX1(): Line<Datum>;
    /**
     * Returns a new line generator that has this area generator鈥檚 current defined accessor, curve and context.
     * The line鈥檚 x-accessor is this area鈥檚 x0-accessor, and the line鈥檚 y-accessor is this area鈥檚 y1-accessor.
     */
    lineY1(): Line<Datum>;
}
 ...
 * except the x and y accessors are replaced with angle and radius accessors.
 * Radial areas are always positioned relative to 鉄?,0鉄? use a transform (see: SVG, Canvas) to change the origin.
 *
 * The generic refers to the data type of an element in the input array passed into the area generator.
 */
export interface AreaRadial<Datum> {
     ...
     *
     * @param angle A constant value in radians with 0 at -y (12 o鈥檆lock).
     */
    angle(angle: number): this;
    /**
     ...
     * If your data are in a different format, or if you wish to transform the data before rendering, then you should specify a custom accessor.
     *
     * @param angle An accessor function returning a value to be used for startAngle in radians with 0 at -y (12 o鈥檆lock).
    ...
    /**
     * Equivalent to area.x1, except the accessor returns the angle in radians, with 0 at -y (12 o鈥檆lock).
     ...
     * If your data are in a different format, or if you wish to transform the data before rendering, then you should specify a custom accessor.
     *
     * @param angle An accessor function returning a value to be used for endAngle in radians with 0 at -y (12 o鈥檆lock).
     * The accessor will be invoked for each defined element in the input data array,
     * being passed the element d, the index i, and the array data as three arguments.
     */
    ...
    /**
     * Equivalent to area.y1, except the accessor returns the radius: the distance from the origin 鉄?,0鉄?
     */
    ...
    /**
     * Returns a new radial line generator that has this radial area generator鈥檚 current defined accessor, curve and context.
     * The line鈥檚 angle accessor is this area鈥檚 start angle accessor, and the line鈥檚 radius accessor is this area鈥檚 inner radius accessor.
     */
    ...
    /**
     * Returns a new radial line generator that has this radial area generator鈥檚 current defined accessor, curve and context.
     * The line鈥檚 angle accessor is this area鈥檚 end angle accessor, and the line鈥檚 radius accessor is this area鈥檚 inner radius accessor.
     */
    lineEndAngle(): LineRadial<Datum>;

    /**
     * Returns a new radial line generator that has this radial area generator鈥檚 current defined accessor, curve and context.
     * The line鈥檚 angle accessor is this area鈥檚 start angle accessor, and the line鈥檚 radius accessor is this area鈥檚 outer radius accessor.
     */
...
/**
 * Produces a B茅zier curve between each pair of points, with horizontal tangents at each point.
 */
export const curveBumpX: CurveFactory;

/**
 * Produces a B茅zier curve between each pair of points, with vertical tangents at each point.
 */
 ...
 * with the spline straightened according to the curve鈥檚 beta, which defaults to 0.85.
...
export interface CurveCardinalFactory extends CurveFactory {
     ...
     * The tension determines the length of the tangents: a tension of one yields all zero tangents, equivalent to curveLinear; a tension of zero produces a uniform Catmull鈥揜om spline.
     *
...
/**
 * A curve factory for cubic Catmull鈥揜om spline generators.
 */
export interface CurveCatmullRomFactory extends CurveFactory {
    /**
     * Returns a cubic Catmull鈥揜om curve factory with the specified alpha in the range [0, 1].
 ...
 * A curve factory for cubic Catmull鈥揜om spline generators.
 *
 * The curve generators produce a cubic Catmull鈥揜om spline using the specified control points and the parameter alpha,
 * which defaults to 0.5, as proposed by Yuksel et al. in On the Parameterization of Catmull鈥揜om Curves,
 ...
 * A curve factory for cubic Catmull鈥揜om spline generators.
 *
 * The curve generators produce a closed cubic Catmull鈥揜om spline using the specified control points and the parameter alpha,
 ...
 * 鈥渁 smooth curve with continuous first-order derivatives that passes through any given set of data points without spurious oscillations.
 * Local extrema can occur only at grid points where they are given by the data, but not in between two adjacent grid points.鈥? */
...
export interface DefaultLinkObject {
     ...
     * the coordinates [angle, radius]. The angle is stated in radians, with 0 at -y (12 o鈥檆lock).
     * The radius measures the distance from the origin 鉄?,0鉄?
     */
...
/**
 * A link generator for a Cartesian coordinate system. The link shape generates a smooth cubic B茅zier curve from a
...
export interface LinkRadial<This, LinkDatum, NodeDatum> {
     ...
     * The angle is stated in radians, with 0 at -y (12 o鈥檆lock).
     *
     ...
     * The radius is measured as the distance from the origin 鉄?,0鉄?
     *
 ...
 * A symbol generator.
 *
 * Symbols provide a categorical shape encoding as is commonly used in scatterplots. Symbols are always centered at 鉄?,0鉄?
...
export interface Symbol<This, Datum> {
     ...
     * If you wish to scale the symbol to fit a given bounding box, rather than by area, try SVG鈥檚 getBBox.
     *
 ...
 * @param angle Angle in radians, with 0 at -y (12 o鈥檆lock) and positive angles proceeding clockwise.
 * @param radius Radius.
 */
...
export interface Stack<This, Datum, Key> {
     ...
     *
     * Any additional arguments are arbitrary; they are simply propagated to the generator鈥檚 accessor functions along with the this object.
     *
     * @param data Array of data elements.
     */
     ...
     * The series鈥?key is passed to the value accessor, along with each data point, to compute the point鈥檚 value.
     */
 ...
 * This order is recommended for streamgraphs in conjunction with the wiggle offset. See Stacked Graphs鈥擥eometry & Aesthetics by Byron & Wattenberg for more information.
 *
 * @param series A series generated by a stack generator.
 */
...
/**
 * Returns the given series order [0, 1, 鈥?n - 1] where n is the number of elements in series. Thus, the stack order is given by the key accessor.
 *
 * @param series A series generated by a stack generator.
 */
...
/**
 * Returns the reverse of the given series order [n - 1, n - 2, 鈥?0] where n is the number of elements in series. Thus, the stack order is given by the reverse of the key accessor.
 *
 * @param series A series generated by a stack generator.
 */
 ...
 * See Stacked Graphs鈥擥eometry & Aesthetics by Bryon & Wattenberg for more information.
 *
 * @param series A series generated by a stack generator.
 * @param order An array of numeric indexes representing the stack order.
 */
