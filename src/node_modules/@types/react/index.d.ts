...
declare namespace React {
     ...
     * @param initialValue A value to use during the initial render of a component. If this option is omitted, `useDeferredValue` will not defer during the initial render, because there鈥檚 no previous version of `value` that it can render instead.
     *
