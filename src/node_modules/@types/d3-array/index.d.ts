...
/**
 * Returns an unbiased estimator of the population variance of the given iterable of numbers using Welford鈥檚 algorithm.
...
export class Adder {
    ...
    /**
     * Adds the specified number to the adder鈥檚 current value and returns the adder.
     */
    add(number: number): Adder;

    /**
     * Returns the IEEE 754 double precision representation of the adder鈥檚 current value.
...
/**
 * Equivalent to group, but returns a flat array of [key0, key1, 鈥? values] instead of nested maps.
 *
 * @param iterable The iterable to group.
 * @param keys The key functions.
 */
...
/**
 * Equivalent to rollup, but returns a flat array of [key0, key1, 鈥? value] instead of nested maps.
 *
 * @param iterable The iterable to group.
 * @param reduce The reduce function.
 * @param keys The key functions.
...
/**
 * Randomizes the order of the specified array using the Fisher鈥揧ates shuffle.
 */
 ...
 * nicely-rounded values consistent with the inferred step. More formally, each returned tick t satisfies start 鈮?t and t 鈮?stop.
 *
